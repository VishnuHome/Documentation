...
<head>
  ...
  "97ecd117-8937-4aca-bb5d-dfab02559f5e">
  <meta name="Microsoft.Help.ContentType" content="Concepts">
  <meta name="Description" content=
  "Pages of interest for a quick start">
  <link rel="stylesheet" type="text/css" href=
...
<body onload="SetDefaultLanguage('cs');">
  ...
  <div class="pageBody">
    <div class="leftNav" id="leftNav">
      <div id="tocNav">
        ...
        <div class="toclevel2" data-toclevel="2">
          ...
          "Vishnu control" tocid=
          "6fe3bf85-d02b-41ff-84a7-dcc2a4819978">Vishnu Control</a>
        </div>
        <div class="toclevel2" data-toclevel="2">
          <a data-tochassubtree="false" href=
          "../html/4bf9a24d-ba9e-4aa0-8074-8bd775767f73.htm" title=
          "Where does the name come from" tocid=
          "4bf9a24d-ba9e-4aa0-8074-8bd775767f73">Where does the name come from</a>
        </div>
      </div>
    ...
    <div id="TopicContent" class="topicContent">
      ...
      <div>
        <p>Pages of interest for a quick start</p>
      </div>
      <div class="collapsibleAreaRegion" id="Inhalt">
        ...
        "../icons/SectionExpanded.png">Contents</span>
      </div>
      <div id="IDDABSection" class="collapsibleSection">
        <p>Please select a topic to continue reading.</p>
        <ul>
          <li>
            <p><a href="62ca75a8-ba50-4115-93df-b1e76bf6e5f7.htm">a
            simple example</a></p>
          </li>
          <li>
            <p><a href=
            "6fe3bf85-d02b-41ff-84a7-dcc2a4819978.htm">Vishnu
            keyboard and mouse control</a></p>
          </li>
          <li>
            <p><a href=
            "4bf9a24d-ba9e-4aa0-8074-8bd775767f73.htm">Where does
            the name come from?</a></p>
          </li>
        </ul>
      </div>
    </div>
